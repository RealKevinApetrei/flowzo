...
| Create detailed demo script (step-by-step walkthrough for judges, with fallback paths) | P0 | 1.5h | TODO |
| Build pitch deck (5 slides: Problem, Data Pipeline, Prediction, Decision Engine, Validation) | P0 | 3h | TODO |
