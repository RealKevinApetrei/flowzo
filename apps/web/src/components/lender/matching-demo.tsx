        ...
        <div className="px-4 pb-4">
          ...
          {currentStep >= 0 && (
            <div className={`rounded-xl bg-soft-white p-3 mt-2 transition-opacity duration-300 ${currentStep === 0 ? "ring-2 ring-coral/30" : ""}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-5 h-5 rounded-full bg-coral text-white text-[10px] font-bold flex items-center justify-center shrink-0">1</span>
                <p className="text-[10px] font-bold text-text-muted uppercase tracking-wide">Incoming Trade</p>
              </div>
          ...
          {currentStep >= 1 && (
            <div className={`rounded-xl bg-soft-white p-3 mt-2 transition-opacity duration-300 ${currentStep === 1 ? "ring-2 ring-coral/30" : ""}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-5 h-5 rounded-full bg-coral text-white text-[10px] font-bold flex items-center justify-center shrink-0">2</span>
                <p className="text-[10px] font-bold text-text-muted uppercase tracking-wide">ML Re-scoring</p>
              </div>
          ...
          {currentStep >= 2 && (
            <div className={`rounded-xl bg-soft-white p-3 mt-2 transition-opacity duration-300 ${currentStep === 2 ? "ring-2 ring-coral/30" : ""}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-5 h-5 rounded-full bg-coral text-white text-[10px] font-bold flex items-center justify-center shrink-0">3</span>
                <p className="text-[10px] font-bold text-text-muted uppercase tracking-wide">Eligibility Filter ({eligibleLenders.length}/{scoredLenders.length} pass)</p>
              </div>
          ...
          {currentStep >= 3 && (
            <div className={`rounded-xl bg-soft-white p-3 mt-2 transition-opacity duration-300 ${currentStep === 3 ? "ring-2 ring-coral/30" : ""}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-5 h-5 rounded-full bg-coral text-white text-[10px] font-bold flex items-center justify-center shrink-0">4</span>
                <p className="text-[10px] font-bold text-text-muted uppercase tracking-wide">Lender Scoring (scored_v2)</p>
              </div>
          ...
          {currentStep >= 4 && (
            <div className={`rounded-xl bg-soft-white p-3 mt-2 transition-opacity duration-300 ${currentStep === 4 ? "ring-2 ring-coral/30" : ""}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-5 h-5 rounded-full bg-coral text-white text-[10px] font-bold flex items-center justify-center shrink-0">5</span>
                <p className="text-[10px] font-bold text-text-muted uppercase tracking-wide">Fund Allocation (max {MAX_SINGLE_LENDER_PCT * 100}% per lender)</p>
              </div>
              {/* Allocation bar */}
          ...
          {currentStep >= 5 && (
            <div className={`rounded-xl bg-soft-white p-3 mt-2 transition-opacity duration-300 ${currentStep === 5 ? "ring-2 ring-coral/30" : ""}`}>
              <div className="flex items-center gap-2 mb-2">
                <span className="w-5 h-5 rounded-full bg-coral text-white text-[10px] font-bold flex items-center justify-center shrink-0">6</span>
                <p className="text-[10px] font-bold text-text-muted uppercase tracking-wide">Fee Split (Senior / Junior Tranche)</p>
              </div>
              <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                {isFullyMatched ? (
                  <>
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="w-5 h-5 rounded-full bg-success text-white text-[10px] font-bold flex items-center justify-center shrink-0">7</span>
                  ...
                  <>
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="w-5 h-5 rounded-full bg-warning text-white text-[10px] font-bold flex items-center justify-center shrink-0">7</span>
